...
print(fill_below.aggregate(lambda x: (sum(x)/len(x)), 'games'))
print(fill_above.aggregate(lambda x: (sum(x)/len(x)), 'games'))
...
print(fill_forwards.aggregate(lambda x: (sum(x)/len(x)), 'passes'))
print(fill_midfielders.aggregate(lambda x: (sum(x)/len(x)), 'passes'))
